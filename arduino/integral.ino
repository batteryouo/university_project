...
uint8_t teapotPacket[50] = { '$', 0x03, 0,0x00,0,0x00, 0,0x00,0,0x00, 0,0x00,0,0x00, 0,0x00,0,0x00,\
 0,0x00,0,0x00, 0,0x00,0,0x00, 0,0x00,0,0x00, 0,0x00,0,0x00, 0,0x00,0,0x00, 0,0x00,0,0x00, 0,0x00,0,0x00,\
 0x00, 0x00, '\r', '\n' };
...
void loop() {
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
        ...
        teapotPacket[4] = fifoBuffer[1];
        teapotPacket[6] = fifoBuffer[4];
        teapotPacket[8] = fifoBuffer[5];
        teapotPacket[10] = fifoBuffer[8];
        teapotPacket[12] = fifoBuffer[9];
        teapotPacket[14] = fifoBuffer[12];
        teapotPacket[16] = fifoBuffer[13];
        // gyro values
        teapotPacket[18] = fifoBuffer[16];
        teapotPacket[20] = fifoBuffer[17];
        teapotPacket[22] = fifoBuffer[20];
        teapotPacket[24] = fifoBuffer[21];
        teapotPacket[26] = fifoBuffer[24];
        teapotPacket[28] = fifoBuffer[25];
        // accelerometer values
        teapotPacket[30] = fifoBuffer[28];
        teapotPacket[32] = fifoBuffer[29];
        teapotPacket[34] = fifoBuffer[32];
        teapotPacket[36] = fifoBuffer[33];
        teapotPacket[38] = fifoBuffer[36];
        teapotPacket[40] = fifoBuffer[37];
        //temperature
        int16_t temperature = mpu.getTemperature();
        teapotPacket[42] = temperature >> 8;
        teapotPacket[44] = temperature & 0xFF;
        Serial.write(teapotPacket, 50);
        teapotPacket[47]++; // packetCount, loops at 0xFF on purpose
...
void A1_16_SetPosition(unsigned char _pID, uint16_t _CMD,  unsigned char _playtime, unsigned int _position) {
  ...
  _data[1] = (_position >> 8 & 0xff); //msb最左
